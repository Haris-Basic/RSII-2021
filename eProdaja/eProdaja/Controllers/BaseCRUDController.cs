...
namespace eProdaja.Controllers
{
    ...
    {
        protected readonly ICRUDServiceb<T, TSearch, TInsert, TUpdate> _crudService;
        public BaseCRUDController(ICRUDServiceb<T, TSearch, TInsert, TUpdate> service) : base(service)
        {
